...
function ToegankelijkheidView({ toegankelijkheidItems, onAdd, onUpdate, onDelete, hasEditPermissions }) {
    ...
    const filteredItems = toegankelijkheidItems.filter(item => 
    ...
    return (
        <div>
            ...
            {isModalOpen && <ContentForm item={editingItem} itemTypeLabel="Toegankelijkheid" onClose={() => setIsModalOpen(false)} onSave={(data) => {
...
export default ToegankelijkheidView;
